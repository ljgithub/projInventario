...
import com.uisrael.inventarioproyecto.modelo.IGenericaDao;
...
public class GenericaDaoImpl<T> implements IGenericaDao<T> {
    ...
    protected static final EntityManagerFactory emf = Persistence.createEntityManagerFactory("Inventario_Proj_PU");
